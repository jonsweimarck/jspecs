package se.bitbybit.jspecs.junitspecific;
...
import se.bitbybit.jspecs.SpecificationSupplier;

import java.util.ArrayList;
import java.util.List;

import static se.bitbybit.jspecs.junitspecific.SpecificationLogger.Singelton.INSTANCE;
